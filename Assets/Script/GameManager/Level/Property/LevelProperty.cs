...
public class LevelProperty : MonoBehaviour
{
    ...
    public GameObject GetEndDoor() => go_EndDoor;
    ...
    void OnEnable()
    {
        ...
        // Initialize all the link between the Level and other GameObject than Character
        LevelManager_Initiation.Instance.InitializeLevelSubscription(gameObject);
    ...
    {
        // Unsubscribe the listen of the event End of Door to launch the LevelManger.ChangeNextLevel
        LevelManager_Initiation.Instance.InitializeLevelUnsubscription(gameObject);
    }

    /// <summary>
    /// Function that trigger the next level method when the character is passing the BoxCollider of the EndDoor
    /// </summary>
    public void TriggerEndDoorAction()
    {
